<div class="card col col-lg-5 mx-3 mx-lg-auto p-0">
    ...
    <form class="form w-full max-w-lg mx-auto" method="post" action="<?php $_SERVER['PHP_SELF']; ?>">
        <div class="flex flex-wrap -mx-3 mb-6 justify-between">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0 flex-grow">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="title">
                    Title
                </label>
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="title" id="title" type="text">
            ...
            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                ...
                <div class="relative">
                    <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="prio" id="prio">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
                ...
                <textarea class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-48" name="desc" id="desc"></textarea>
                <p class="error-p text-red-500 text-xs italic hidden"></p>
            </div>
        </div>
        <div class="flex flex-wrap -mx-3 mb-2">
            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0 flex-grow">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="due" id="due" type="date" require>
                <p class="error-p text-red-500 text-xs italic hidden"></p>
            </div>
        </div>
