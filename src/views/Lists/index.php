<div class="mx-6">
        ...
        <div class="to-do-list striped flex flex-col justify-between items-start">
            ...
            <?php foreach ($viewmodel as $item) : ?>
                <div class="to-do-item grid grid-cols-12 gap-2 border-b-2 border-black w-full">
                    ...
                    <div class="item_info grid-cols-subgrid col-span-5 p-2 border-r-2 border-black">
                        ...
                        <p class="item_desc text-sm text-gray-500 overflow-hidden"><?php echo $item['create_date']; ?></p>
                    </div>
    ...
    <?php else : ?>
        <p class="text-3xl font-semibold">Please <span class="text-blue-600 hover:underline"><a href="<?php echo ROOT_PATH; ?>users/login">log in</a></span> first to view your to do list!</p>
    <?php endif; ?>
</div>